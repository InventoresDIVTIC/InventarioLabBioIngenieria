                                        ...
                                        <div class="w-full px-6 mt-6 sm:w-1/2 xl:w-1/3 sm:mt-0">
                                            <div class="flex items-center px-5 py-6 bg-white rounded-md shadow-sm">
                                                ...
                                                <div class="mx-5">
                                                    ...
                                                    <div class="text-gray-500">TOTAL DE ACTIVOS</div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="w-full px-6 mt-6 sm:w-1/2 xl:w-1/3 xl:mt-0">
                                            <div class="flex items-center px-5 py-6 bg-white rounded-md shadow-sm">
                                                ...
                                                <div class="mx-5">
                                                    ...
                                                    <div class="text-gray-500">TOTAL DE PROVEEDORES</div>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                                    ...
                                                    <tr>
                                                        <td class="px-6 py-4 whitespace-no-wrap border-b border-gray-200">
                                                            <div class="flex items-center">
                                                                ...
                                                                <div class="ml-4">
                                                                    <div class="text-sm font-medium leading-5 text-gray-900">Jesús Alejandro
                                                                    </div>
                                                                    <div class="text-sm leading-5 text-gray-500">example@alumnos.udg.mx</div>
                                                                </div>
                                                            </div>
                                                        </td>
                                                        <td class="px-6 py-4 whitespace-no-wrap border-b border-gray-200">
                                                            <div class="text-sm leading-5 text-gray-900">Ingeniero de software</div>
                                                            <div class="text-sm leading-5 text-gray-500">Web designer</div>
                                                        </td>
                                                        <td class="px-6 py-4 whitespace-no-wrap border-b border-gray-200">
                                                            <span
