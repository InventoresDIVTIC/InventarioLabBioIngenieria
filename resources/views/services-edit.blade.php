                        ...
                        <div x-show="pantalla === 1">
                            <div class="grid grid-cols-2 gap-6">
                                ...
                                <div>
                                    ...
                                    <x-text-input id="assigned_engineer" name="assigned_engineer" type="text" class="mt-1 w-full" required autofocus autocomplete="assigned_engineer" />
                                ...
                                <div>
                                    ...
                                    <x-text-input id="active_model" name="active_model" type="text" class="mt-1 w-full" required autofocus autocomplete="active_model" />
                                    <x-input-error class="mt-2" :messages="$errors->get('active_model')" />
                                </div>
                                <div>
                                    <x-input-label for="active_sublocation" :value="__('Sub Ubicación')" />
                                    <div x-data="customSelect()">
                                    <select id="active_sublocation" name="active_sublocation" class="mt-1 block w-full bg-gray-800 text-white" required autofocus autocomplete="active_sublocation"  @change="selectOption($event)">
                                    ...
                                    <input type="hidden" name="active_sublocation" x-bind:value="selectedValue">
                                    </div>
                                ...
                                <div>
                                    ...
                                    <x-text-input id="foil" name="foil" type="text" class="mt-1 w-full" required autofocus autocomplete="foil" />
                                    <x-input-error class="mt-2" :messages="$errors->get('foil')" />
                                </div>
                                <div>
                                    <x-input-label for="origin" :value="__('Origen')" />
                                    <x-text-input id="origin" name="origin" type="text" class="mt-1 w-full" required autofocus autocomplete="origin" />
                                    <x-input-error class="mt-2" :messages="$errors->get('origin')" />
                                </div>
                                <div>
                                    <x-input-label for="reference" :value="__('Referencia')" />
                                    <x-text-input id="reference" name="reference" type="text" class="mt-1 w-full" required autofocus autocomplete="reference" />
                        ...
                        <div x-show="pantalla === 2">
                            <div class="grid grid-cols-2 gap-6">
                                <div>
                                    ...
                                    <x-text-input id="assigned_enginier" name="assigned_enginier" type="text" class="mt-1 w-full" required autofocus autocomplete="assigned_enginier" />
                            ...
                            <div class="grid grid-cols-2 gap-6">
                                <div>
                                    ...
                                    <input id="start_date" name="start_date" type="date" class="mt-1 w-full" required autofocus autocomplete="start_date" />
                            ...
                            <div class="grid grid-cols-2 gap-6">
                                <div>
                                    ...
                                    <input id="end_date" name="end_date" type="date" class="mt-1 w-full" required autofocus autocomplete="end_date" />
                            ...
                            <div class="grid grid-cols-2 gap-6">
                                <div>
                                    ...
                                    <input id="hours" name="hours" type="time" class="mt-1 w-full" required autofocus autocomplete="hours" />
                            ...
                            <div class="grid grid-cols-2 gap-6">
                                <div>
                                    ...
                                    <input id="minutes" name="minutes" type="time" class="mt-1 w-full" required autofocus autocomplete="minutes" step="60" />
                                    <x-input-error class="mt-2" :messages="$errors->get('minutes')" />
                                </div>
                            </div>
                            <div>
                                <x-input-label for="summary" :value="__('Resumen')" />
                                <x-text-input id="summary" name="summary" type="text" class="mt-1 w-full" required autofocus autocomplete="summary" />
                         ...
                         <div x-show="pantalla === 3">
                            <div class="grid grid-cols-2 gap-6">
                                <div>
                                    ...
                                    <canvas id="serviceHeadSignatureCanvas" class="mt-1 w-full" style="border: 1px solid #000;"></canvas>
                                    <input type="hidden" id="service_head_signature" name="service_head_signature" />
                                    <x-input-error class="mt-2" :messages="$errors->get('service_head_signature')" />

                                    <!-- Botón para limpiar la firma -->
                                    <button type="button" id="clearServiceHeadSignatureButton" class="mt-2 bg-red-500 hover:bg-red-700 text-white font-bold py-2 px-4 rounded">Limpiar Firma</button>
                                </div>
                            </div>
                            ...
                            <div class="grid grid-cols-2 gap-6">
                                <div>
                                    ...
                                    <canvas id="serviceEngineerSignatureCanvas" class="mt-1 w-full" style="border: 1px solid #000;"></canvas>
                                    <input type="hidden" id="service_engineer_signature" name="service_engineer_signature" />
                                    <x-input-error class="mt-2" :messages="$errors->get('service_engineer_signature')" />

                                    <!-- Botón para limpiar la firma -->
                                    <button type="button" id="clearServiceEngineerSignatureButton" class="mt-2 bg-red-500 hover:bg-red-700 text-white font-bold py-2 px-4 rounded">Limpiar Firma</button>
                                </div>
                            </div>
                            ...
                            <div class="grid grid-cols-2 gap-6">
                                <div>
                                    ...
                                    <canvas id="lastUserSignatureCanvas" class="mt-1 w-full" style="border: 1px solid #000;"></canvas>
                                    ...
                                    <!-- Botón para limpiar la firma -->
                                    <button type="button" id="clearLastUserSignatureButton" class="mt-2 bg-red-500 hover:bg-red-700 text-white font-bold py-2 px-4 rounded">Limpiar Firma</button>
                                </div>
                            </div>
                            ...
                            <script>
                                ...
                                form.addEventListener('submit', function (event) {
                                    if (serviceHeadSignaturePad.isEmpty() || serviceEngineerSignaturePad.isEmpty() || lastUserSignaturePad.isEmpty()) {
                        ...
                        <div x-show="pantalla === 4">
                            <div class="grid grid-cols-1 gap-6">
                                <div>
                                    ...
                                    <x-text-input id="service_expense" name="service_expense" type="text" class="mt-1 w-full" required autofocus autocomplete="service_expense" />
                            ...
                            <div class="grid grid-cols-1 gap-6">
                                <div>
                                    ...
                                    <x-text-input id="parts_expense" name="parts_expense" type="text" class="mt-1 w-full" required autofocus autocomplete="parts_expense" />
                            ...
                            <div class="grid grid-cols-1 gap-6">
                                <div>
                                    ...
                                    <x-text-input id="total" name="total" type="text" class="mt-1 w-full" required autofocus autocomplete="total" />
                            ...
                            <div class="grid grid-cols-1 gap-6">
                                <div>
                                    ...
                                    <x-text-input id="annex" name="annex" type="text" class="mt-1 w-full" required autofocus autocomplete="annex" />
